...
if (!isset($_SESSION['userInformation']->$selectedFacebookPage->linkedIn)) {
    echo '<span class="account_network">LinkedIn</span>';
    ...
    // Get US Content
    echo '<span class="account_network_content"><span class="account_network">LinkedIn</span>';
    echo '' . $user_data->firstName->localized->en_US . ' ' . $user_data->lastName->localized->en_US .
        ' | <a href="logout.php?logOutLinkedIn=' . $selectedFacebookPage . '">Log Out</a>';
    ...
    if (!isset($_SESSION['userInformation']->$selectedFacebookPage->linkedIn->companyTarget)) {
        ...
        foreach ($user_data->elements as $user_companies_data) {
            ...
            echo '<a href="./?linkedInCompany=' . $user_companies_data->organizationalTarget . '">' . 
            $user_companies_data->$cat->localizedName . '</a>';
        }
